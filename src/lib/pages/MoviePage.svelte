<script lang="ts">
	...
	function createConfirmDeleteSeasonDialog(files: MovieFileResource[]) {
		createModal(ConfirmDialog, {
			...
			body: $_('library.content.confirmDeleteSeasonBody', { count: files.length }), // TODO: These messages  could be better, for series too
			confirm: () =>
				radarrApi
	...
	function createConfirmCancelDownloadsDialog(downloads: MovieDownload[]) {
		createModal(ConfirmDialog, {
			...
			body: $_('library.content.confirmCancelDownloadsBody', { count: downloads.length }), // TODO: These messages  could be better, for series too
			confirm: () =>
				radarrApi
