...
export interface components {
  schemas: {
     ...
     * @enum {string}
     */
    ExternalIdMediaType: "Album" | "AlbumArtist" | "Artist" | "BoxSet" | "Episode" | "Movie" | "OtherArtist" | "Person" | "ReleaseGroup" | "Season" | "Series" | "Track";
    ExternalUrl: {
      /** @description Gets or sets the name. */
      Name?: string | null;
